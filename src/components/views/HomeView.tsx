...
const DATA_TOOLS_LIST = [
  ...
  { slug: 'pdf-table-to-chart', name: 'PDF Table Extractor & Visualizer', description: 'Extract tabular data from PDF files and convert them to interactive graphs.', category: 'Data Tools', icon: 'FileText', badge: 'POPULAR' as const, href: '/pdf-table-to-chart' },
